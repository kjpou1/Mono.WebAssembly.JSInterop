...
extern MonoObject* mono_wasm_get_js_global (MonoString *method, int is_managed, int *is_exception);
extern MonoObject* mono_wasm_get_js_property (int js_handle, MonoString *method, int is_managed, int *is_exception);
extern MonoObject* mono_wasm_set_js_property (int js_handle, MonoString *method, MonoObject *value, int createIfNotExist, int hasOwnProperty, int is_managed, int *is_exception);
extern MonoObject* mono_wasm_get_js_style_attribute (int js_handle, MonoString *attrName, int *is_exception);
extern MonoObject* mono_wasm_set_js_style_attribute (int js_handle, MonoString *attrName, MonoObject *value, int *is_exception);
extern MonoObject* mono_wasm_add_js_event_listener (int js_handle, MonoString *typeListener, MonoObject *delegate, int uid, int *is_exception);
...
mono_wasm_load_runtime (const char *managed_path, int enable_debugging)
{
	...
	mono_add_internal_call ("Mono.WebAssembly.JSInterop.InternalCalls::InvokeJS", mono_wasm_invoke_js);
	mono_add_internal_call ("Mono.WebAssembly.JSInterop.InternalCalls::InvokeJSWithArgs", mono_wasm_invoke_js_with_args);
	mono_add_internal_call ("Mono.WebAssembly.JSInterop.InternalCalls::GetJSGlobal", mono_wasm_get_js_global);
	mono_add_internal_call ("Mono.WebAssembly.JSInterop.InternalCalls::GetJSProperty", mono_wasm_get_js_property);
	mono_add_internal_call ("Mono.WebAssembly.JSInterop.InternalCalls::SetJSProperty", mono_wasm_set_js_property);
	mono_add_internal_call ("Mono.WebAssembly.JSInterop.InternalCalls::GetJSStyleAttribute", mono_wasm_get_js_style_attribute);
	mono_add_internal_call ("Mono.WebAssembly.JSInterop.InternalCalls::SetJSStyleAttribute", mono_wasm_set_js_style_attribute);
	mono_add_internal_call ("Mono.WebAssembly.JSInterop.InternalCalls::AddJSEventListener", mono_wasm_add_js_event_listener);
	
	mono_add_internal_call ("Mono.WebAssembly.JSInterop.InternalCalls::InvokeJSMarshalled", mono_wasm_invoke_js_marshalled);
	mono_add_internal_call ("Mono.WebAssembly.JSInterop.InternalCalls::InvokeJSUnmarshalled", mono_wasm_invoke_js_unmarshalled);
}
...
EMSCRIPTEN_KEEPALIVE MonoString *
mono_wasm_get_enum_type_name (MonoObject *obj)
{
	...
	return mono_string_new (root_domain, mono_type_get_name(type));
}
